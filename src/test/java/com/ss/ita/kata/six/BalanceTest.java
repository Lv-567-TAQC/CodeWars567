...
public class BalanceTest extends SixDataProviderImplementation{
    private final Six implementation;

    public BalanceTest(final Six implementation) {
    ...
    public void testBalance1() {
            ...
            String ans = implementation.balance(b1);
        try {
    ...
    public void testBalance2() {
            ...
            String ans = implementation.balance(b2);
        try {
