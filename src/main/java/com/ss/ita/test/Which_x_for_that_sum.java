...
class Which_x_for_that_sum {
    ...
    void solveSumDefaultTest() {
        ...
        for(Five implementation: implementations){
            ...
            assertEquals(0.5,implementation.solveSum(2.0),1e-12,
                    String.format("Test %s failed!",implementation.getClass()));
            assertEquals(0.7034648345913732,implementation.solveSum(8.0),1e-12,
                    String.format("Test %s failed!",implementation.getClass()));
            assertEquals(6.096117967978e-01,implementation.solveSum(4.0),1e-12,
                    String.format("Test %s failed!",implementation.getClass()));
        }
